...
export class DataBase {
    ...
    addLojasAoMunicipio(): void{
        this.lojas.forEach(element => {
            switch (element.municipio?.nomeMunicipio) {
                case "Afogados da Ingazeira - PE":
                    this.municipios.forEach(mu => {
                        if (mu.nomeMunicipio === "Afogados da Ingazeira - PE") {
                            mu.lojas.push(element);
                        }
                    });
                    break;
                case "São José do Egito - PE":
                    this.municipios.forEach(mu => {
                        if (mu.nomeMunicipio === "São José do Egito - PE") {
                            mu.lojas.push(element);
                        }
                    });
                    break;
                ...
                case "Iguaracy - PE":
                    this.municipios.forEach(mu => {
                        if (mu.nomeMunicipio === "Iguaracy - PE") {
                            mu.lojas.push(element);
                        }
                    });
                    break;
                ...
                case "Tuparetama - PE":
                    this.municipios.forEach(mu => {
                        if (mu.nomeMunicipio === "Tuparetama - PE") {
                            mu.lojas.push(element);
                        }
                    });
                    break;
    ...
    cadastrarLoja(): void {
        this.lojas.push(this.criarLoja("Americanas Express",
            ...
            20, this.criarMunicipio("", "Tuparetama - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));
        ...
        this.lojas.push(this.criarLoja("Magazine Luiza",
            ...
            22, this.criarMunicipio("", "Afogados da Ingazeira - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));

        this.lojas.push(this.criarLoja("Ponto Frio",
            "https://img.ibxk.com.br/2016/4/programas/9051012161233751.png",
            15, this.criarMunicipio("", "São José do Egito - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"));


        this.lojas.push(this.criarLoja("Ponto Frio",
            "https://img.ibxk.com.br/2016/4/programas/9051012161233751.png",
            15, this.criarMunicipio("", "Tuparetama - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));
        ...
        this.lojas.push(this.criarLoja("Casas Bahia",
            ...
            17, this.criarMunicipio("", "Tuparetama - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));

        this.lojas.push(this.criarLoja("A C Closet",
            "https://i.pinimg.com/originals/93/eb/f5/93ebf5c2fe5bf008357547863b7ac369.jpg",
            5, this.criarMunicipio("", "São José do Egito - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));
        ...
        this.lojas.push(this.criarLoja("C&A",
            ...
            7, this.criarMunicipio("", "Afogados da Ingazeira - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));

        this.lojas.push(this.criarLoja("Marisa",
            "https://www.vitoriaparkshopping.com/wp-content/uploads/2016/12/logo_site-13.png",
            10, this.criarMunicipio("", "Afogados da Ingazeira - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));

        this.lojas.push(this.criarLoja("Mesbla",
            "https://raichu-uploads.s3.amazonaws.com/logo_mesbla-com_JdL6uQ.png",
            6, this.criarMunicipio("", "Afogados da Ingazeira - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));
        ...
        this.lojas.push(this.criarLoja("Padaria São João",
            ...
            4, this.criarMunicipio("", "Tabira - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));

        this.lojas.push(this.criarLoja("Mesbla",
            "https://raichu-uploads.s3.amazonaws.com/logo_mesbla-com_JdL6uQ.png",
            8, this.criarMunicipio("", "Tabira - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));
        ...
        this.lojas.push(this.criarLoja("Posto da Cidade",
            ...
            90, this.criarMunicipio("", "Tabira - PE"), "https://goo.gl/maps/cNDjtrudYkwnR8kY6"
        ));
    }
